	...
	<div align="center">
		<table border="1">
			...
			<tr>
				...
				<td>자바</td>
				<td>
					<a href="req_video_ok.jsp?num=1">자바의 기본내용을 학습</a>
				</td>
				<td>2020.01.02</td>
			</tr>
			<tr>
				...
				<td>자바스크립트</td>
				<td>
					<a href="req_video_ok.jsp?num=2">자바스크립트의 기본내용을 학습</a>
				</td>
				<td>2020.02.12</td>
			</tr>
			<tr>
				<td>
					<a href="req_video_ok.jsp?num=3">
						<img src="img/oracle.png" width="100px" alt="오라클">
					</a>
				</td>
				<td>오라클</td>
				<td>
					<a href="req_video_ok.jsp?num=3">오라클의 기본내용을 학습</a>
				</td>
				<td>2020.03.14</td>
			</tr>
		</table>
